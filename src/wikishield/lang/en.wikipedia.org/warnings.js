	...
	"Content Issues": {
		...
		warnings: [
...

			{
				...
				show: edit => edit?.page?.namespace % 2 === 0
			},
			{
				reportable: true,
				...
				show: edit => edit?.page?.namespace % 2 === 1
			},
	...
	"Conduct": {
		...
		warnings: [
			...
			},
			{
				...
				auto: edit => +edit?.user?.edits < 500 ?  "notice" : "warning",
				templates: [
		...
		warnings: [
			{
				...
				auto: edit => +edit?.user?.edits < 500 ? "newcomer" : "experienced",
				templates: [
